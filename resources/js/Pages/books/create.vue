...
<template>
    <div class="flex justify-center items-center min-h-screen text-black">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
            <h1 class="text-3xl font-bold mb-6 text-center troy_web_color">Create a New Book</h1>
            <form @submit.prevent="create_book" v-if="permission" class="space-y-6">
                <div>
                    <label for="title" class="block text-sm font-medium mb-2 troy_web_color">Title:</label>
                ...
                <div>
                    <label for="author" class="block text-sm font-medium mb-2 troy_web_color">Author:</label>
                ...
                <div>
                    <label for="description" class="block text-sm font-medium mb-2 troy_web_color">Description:</label>
                ...
                <div>
                    <label for="cover_image" class="block text-sm font-medium mb-2 troy_web_color">Cover Image:</label>
                ...
                <div>
                    <label for="publisher" class="block text-sm font-medium mb-2 troy_web_color">Publisher:</label>
                ...
                <div>
                    <label for="publication_date" class="block text-sm font-medium mb-2 troy_web_color">Publication Date:</label>
                ...
                <div>
                    <label for="category" class="block text-sm font-medium mb-2 troy_web_color">Category:</label>
                ...
                <div>
                    <label for="isbn" class="block text-sm font-medium mb-2 troy_web_color">ISBN:</label>
                ...
                <div>
                    <label for="page_count" class="block text-sm font-medium mb-2 troy_web_color">Page Count:</label>
